...
CELL_PHONE_FIELD = StrFieldConfig(str, min_len=11, max_len=11, validator=FieldValidator.validate_cell_phone)
PHONE_FIELD = StrFieldConfig(str, min_len=10, max_len=10, validator=FieldValidator.validate_phone)
